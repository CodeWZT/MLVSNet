            ...
            for PCs, BBs, list_of_anno in batch: # tracklet
                ...
                for i, _ in enumerate(PCs):
                    ...
                    if i == 0:
                        ...
                        estimation_box_cpu_class = estimation_boxs_cpu[box_idx,4]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default = './Car_mvsnet/netR_30.pth',  help='model name for training resume')
    ...
    logging.basicConfig(format='%(asctime)s %(message)s', datefmt='%Y/%m/%d %H:%M:%S', \
                    filename=os.path.join(args.save_root_dir+'test_log/', datetime.now().strftime(''+'-%Y-%m-%d %H-%M-%S.log')), level=logging.INFO)
    logging.info('======================================================')
    # args.model[-11:-4]
    args.manualSeed = 0
